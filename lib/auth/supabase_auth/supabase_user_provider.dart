...
class GiveUpSupabaseUser extends BaseAuthUser {
  GiveUpSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> giveUpSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = GiveUpSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
